...
<head>
    ...
    <title>504 Internal Server Error</title>
...
<body
    ...
    <div style="height:auto; min-height:100%;">
        <div style="text-align: center; width:800px; margin-left: -400px; position:absolute; top: 30%; left:50%;">
            <h1 style="margin:0; font-size:150px; line-height:150px; font-weight:bold;">504</h1>
    ...
    <div
        ...
        <br>Custom error page by your server administrator.
        <p>This is a server-side error. If the issue persists, please contact the website administrator.</p>
    </div>
</body>
